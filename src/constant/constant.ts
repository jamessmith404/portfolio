...
export const Blogs = [
  {
    ...
    title: 'Building Like a Pro: Secret Tools for Flawless NestJS Apps!',
  ...
  },
  {
    ...
    title: `Building Apps with Shipping Containers: A Beginner's Guide to Taking Your App from Idea to Awesome`,
    link: 'https://jamessmith404.bearblog.dev/building-eventable-teamwork-tracking-and-code-like-a-superhero/',
    date: '28 May, 2024',
