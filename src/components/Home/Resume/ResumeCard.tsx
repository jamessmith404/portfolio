    ...
    <div className="mb-6">
      <div className="flex items-start space-x-6 bg-blue-950/20 transition-all duration-300 p-4 sm:p-8 rounded-md">
        ...
        <div className="flex-1 ">
          {date && (
            <h1 className="mb-2 sm:px-6 xm:py-1.5 px-4 py-1 rounded-full bg-gray-200 text-gray-600 w-fit sm:text-lg text-sm font-bold">
              {date}
            </h1>
          )}
          ...
          <h2 className="text-gray-200 text-md sm:text-sm font-light italic">
            {company}
          </h2>
          {description && (
